* Project: 
   * First-order density: 3.409%
   * Change cost: 21.488%
   * Core size: 27.273%
   * Average per-module maintainability index: 134.827
   * Average per-function physical LOC: 11.15
   * Average per-function logical LOC: 3.667
   * Average per-function parameter count: 1.153
   * Average per-function cyclomatic complexity: 1.976
   * Average per-function halstead difficulty: 4.885
   * Average per-function halstead effort: 1256.351
...
* Module 7:
   ...
   * Dependency count: 0
   * Average per-function physical LOC: 5.5
   * Average per-function logical LOC: 1.5
   * Average per-function cyclomatic complexity: 1.25
   * Average per-function cyclomatic density: 95.833%
   * Average per-function halstead difficulty: 2.314
   * Average per-function halstead volume: 42.433
   * Average per-function halstead effort: 107.712
...
* Module 11:
   ...
   * Total lines: 99
   * Maintainability index: 126.121
   * Dependency count: 3
   * Average per-function physical LOC: 13.4
   * Average per-function logical LOC: 3.8
   * Average per-function cyclomatic complexity: 1.4
   * Average per-function cyclomatic density: 58.095%
   * Average per-function halstead difficulty: 4.734
   * Average per-function halstead volume: 104.763
   * Average per-function halstead effort: 876.615
   ...
   * Class: **ClassReport**
      ...
      * Class method: **constructor**
         ...
         * Halstead volume: 195.986
         * Halstead effort: 1130.691
         * Parameter count: 3
...
* Module 26:
   ...
   * Total lines: 86
   * Maintainability index: 157.355
   * Dependency count: 2
   * Average per-function physical LOC: 4.5
   * Average per-function logical LOC: 1
   * Average per-function cyclomatic complexity: 1
   * Average per-function cyclomatic density: 100%
   * Average per-function halstead difficulty: 0.975
   * Average per-function halstead volume: 23.703
   * Average per-function halstead effort: 54.036
